...
#Put the enableWinRM code into a temp PS1 file, Width has to be set or it wraps and destroys the code
$enableWinRM | Out-File -Width 4096 -FilePath .\run.ps1
#====================================================================================================
